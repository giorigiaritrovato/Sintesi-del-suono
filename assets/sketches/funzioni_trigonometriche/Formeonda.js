...
// --- Elementi UI ---
let sliderAmp, sliderFreq, sliderVel;
...
function setup() {
  ...
  sliderVel  = makeSlider(0, 10, 4.0, 0.1, 100, 107, 160);

  // --- Menu Selezione Tipo Onda ---
  selectType = createSelect().class('select-custom');
  selectType.position(10, 142);
  ...
  btnPlay = makeButton('▶ Avvia Audio', 155, 141, 115, toggleOsc);
